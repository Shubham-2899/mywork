...
import { hasErrorsInUserData, userDataValidation } from '../../heplers/UserDataValidation';
        ...
        <Box className="signupBox">
          ...
          <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
            <Grid container spacing={2}>
              ...
              {formErrors.contactError ? <span>{formErrors.contactError}</span> : null}
              <Grid item xs={12}>
                <TextField
                  required
                  fullWidth
              ...
              {formErrors.passwordError ? <span>{formErrors.passwordError}</span> : null}
              <Grid item xs={12}>
                <TextField
                  required
                  fullWidth
              ...
              {formErrors.confirmPassError ? <span>{formErrors.confirmPassError}</span> : null}
            </Grid>
            <Button type="submit" fullWidth variant="contained" className="formBtn" disabled={loading}>
              Sign Up
            </Button>
