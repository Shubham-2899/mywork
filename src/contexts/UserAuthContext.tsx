...
import { AuthContextModel, AuthProviderProps, UserContextState } from '../Interfaces/index';

export const UserStateContext = createContext<UserContextState>({} as UserContextState);

const userAuthContext = React.createContext<AuthContextModel>({} as AuthContextModel);
